    ...
    for l in arq:
        ...
        for i in l:
            if getNaoTerminal(i) != None:
                auxnonterm_userdef.append(getNaoTerminal(i));

nonterm_userdef = []

for i in auxnonterm_userdef:
    for j in i:
        nonterm_userdef.append(j);
    ...
    for l in arq:
        ...
        for i in l:
            if getTerminal(i) != None:
                auxterm_userdef.append(getTerminal(i));

term_userdef = []

for i in auxterm_userdef:
    for j in i:
        term_userdef.append(j);
